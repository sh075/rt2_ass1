...
#include "rt2_ass1/srv/command.hpp"
#include "rt2_ass1/srv/position.hpp"
#include "rt2_ass1/srv/random_position.hpp"
#include <iostream>
#include <chrono>
#include <functional>
#include <memory>
#include <string>
using namespace std;
using UserInt = rt2_ass1::srv::Command;
using GoalPos = rt2_ass1::srv::Position;
using RndPos = rt2_ass1::srv::RandomPosition;
...
RCLCPP_COMPONENTS_REGISTER_NODE(rt2_ass1::StateMachine)	
